    ...
    <div ref={menuRef} className="settings-dropdown-menu">
      ...
      <div className="setting-item setting-item-toggle">
        <div className="setting-item-info">
          ...
          <div className="setting-desc">
            Fall back to note content when text preview property is not set or
            empty
          </div>
        </div>
        <div
      ...
      <div className="setting-item setting-item-dropdown">
        <div className="setting-item-info">
          ...
          <div className="setting-desc">
            Display first image embed in note (wikilink or markdown format), or
            first value of image property
          </div>
        </div>
        <select
          value={(() => {
      ...
      <div className="setting-item setting-item-dropdown">
        <div className="setting-item-info">
          ...
          <div className="setting-desc">
            Control when in-note image embeds are shown alongside image property
            values
          </div>
        </div>
        <select
      ...
      <div className="setting-item setting-item-dropdown">
        <div className="setting-item-info">
          ...
          <div className="setting-desc">
            How cover images are displayed (crop fills container, contain shows
            full image)
          </div>
        </div>
        <select
      ...
      <div className="setting-item setting-item-text">
        <div className="setting-item-info">
          ...
          <div className="setting-desc">
            Property to show in second position
          </div>
        </div>
        <select
      ...
      <div className="setting-item setting-item-toggle">
        <div className="setting-item-info">
          ...
          <div className="setting-desc">
            Display first two properties horizontally
          </div>
        </div>
        <div
      ...
      <div className="setting-item setting-item-text">
        <div className="setting-item-info">
          ...
          <div className="setting-desc">
            Property to show in fourth position
          </div>
        </div>
        <select
      ...
      <div className="setting-item setting-item-toggle">
        <div className="setting-item-info">
          ...
          <div className="setting-desc">
            Display third and fourth properties horizontally
          </div>
        </div>
        <div
      ...
      <div className="setting-item setting-item-dropdown">
        ...
        <select
          ...
          onChange={(e: unknown) => {
            const evt = e as Event & { target: HTMLSelectElement };
            onSettingsChange({
              propertyLabels: evt.target.value as "hide" | "inline" | "above",
            });
          }}
          className="dropdown"
        >
