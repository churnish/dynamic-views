 ...
 * @param hideEmptyMode - How to handle empty values: "show" | "names-hidden" | "all"
 * @param propertyNames - Name display mode: "hide" | "inline" | "above"
 */
export function shouldCollapseField(
  ...
  if (isEmpty) {
    ...
    if (hideEmptyMode === 'names-hidden' && propertyNames === 'hide')
      return true;
  }
