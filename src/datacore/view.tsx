...
export function View({
  ...
  const propertySettingsKey = [
    ...
    settings.propertySet1Above,
    settings.propertySet2Above,
    settings.propertySet3Above,
    settings.propertySet4Above,
    settings.propertySet5Above,
    settings.propertySet6Above,
    settings.propertySet7Above,
