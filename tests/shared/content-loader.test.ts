...
vi.mock('../../src/utils/image', () => ({
  ...
  isExternalUrl: vi.fn((url: string) => /^https?:\/\//i.test(url)),
...
vi.mock('../../src/utils/text-preview', () => ({
...
describe('content-loader', () => {
  ...
  beforeEach(async () => {
    ...
    mockImageUtils = (await import('../../src/utils/image')) as any;
    ...
    mockPreviewUtils = (await import('../../src/utils/text-preview')) as any;
