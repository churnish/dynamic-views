...
- **Relation to scroll-idle**: `onScrollIdle` still provides a final safety net `remeasureAndReposition` + `scheduleDeferredRemeasure` after scroll settles, regardless of what mount remeasure ticks fired during the scroll.
