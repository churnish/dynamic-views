...
description: Bot behaviors, workarounds, and common issue solutions.
---
# Obsidian review bot

The Obsidian plugin review bot runs `eslint-plugin-obsidianmd` with its `recommended` config against PRs. It scans independently of any local ESLint setup.
