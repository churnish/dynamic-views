...
| **Card background hover** (tinted/primary/custom)                          | CSS `.interact`                                    | Same                                                 | `.interact`                          |
...
| **Title underline** (open-on-title)                                        | CSS `.interact .card-title a:is(:hover, :active)` | Same                                                 | `.interact` + `:active`             |
