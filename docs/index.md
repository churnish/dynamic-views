...
| Doc | Read before |
|---|---|
| [card-views-roadmap.md](dev/card-views-roadmap.md) | Working on shared card view performance — card rendering, CardHandle cleanup, property measurement, forced reflow reduction, and status tracking. |
