...
| Deferred remeasure (`scheduleDeferredRemeasure`) | Done | Double-RAF catch for async height changes (image decode, image-ready). **T3**: Catches drift at ~95ms after initial layout, cancelling the 500ms safety net as designed. |
