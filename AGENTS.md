...
- **View names**: ALWAYS capitalize plugin view names: 'Grid', 'Masonry' NOT 'grid', 'masonry'. Do NOT capitalize when referring to the layout itself rather than the view as a whole.
